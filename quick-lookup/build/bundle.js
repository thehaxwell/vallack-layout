var app = (function () {
	...
	class CardinalKeysSet extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$b, create_fragment$b, safe_not_equal, { labels: 0, isActive: 1 });
		}
	}
	...
	class ShortcutsLevel extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$a, create_fragment$a, safe_not_equal, { isActive: 0, isMouseControls: 1 });
		}
	}
	...
	*/
	...
	class Normal extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$9, create_fragment$9, safe_not_equal, { labels: 0, isActive: 1 });
		}
	}
