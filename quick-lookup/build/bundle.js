var app = (function () {
	...
	class ShortcutsLevel extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$9, create_fragment$9, safe_not_equal, { isActive: 0, isMouseControls: 1 });
		}
	}
	...
	*/
	...
	class Normal extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$7, create_fragment$7, safe_not_equal, { labels: 0, isActive: 1 });
		}
	}
	...
	class MouseScroll extends SvelteComponent {
		constructor(options) {
			super();
			init(this, options, instance$4, create_fragment$4, safe_not_equal, { labels: 1, isActive: 0 });
		}
	...
	function create_else_block_3(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*labels*/ 2) normal_changes.labels = /*labels*/ ctx[1].slice(4, 8);
	...
	// (27:6) {#if isMouseControls}
	function create_if_block_3(ctx) {
		let directionarrows;
		let current;

		directionarrows = new DirectionalArrows({
				props: {
					isActive: /*isActive*/ ctx[0],
					labels: /*labels*/ ctx[1].slice(4, 8)
				}
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*labels*/ 2) directionarrows_changes.labels = /*labels*/ ctx[1].slice(4, 8);
	...
	function create_else_block_2(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				const normal_changes = {};
				if (dirty & /*isActive*/ 1) normal_changes.isActive = /*isActive*/ ctx[0];
				if (dirty & /*labels*/ 2) normal_changes.labels = /*labels*/ ctx[1].slice(12, 16);
				normal.$set(normal_changes);
			},
			i(local) {
				if (current) return;
	...
	function create_if_block_2(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*labels*/ 2) mousebuttons_changes.labels = /*labels*/ ctx[1].slice(12, 16);
	...
	function create_else_block_1(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				const normal_changes = {};
				if (dirty & /*isActive*/ 1) normal_changes.isActive = /*isActive*/ ctx[0];
				if (dirty & /*labels*/ 2) normal_changes.labels = /*labels*/ ctx[1].slice(0, 4);
				normal.$set(normal_changes);
			},
			i(local) {
				if (current) return;
	...
	function create_if_block_1(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*labels*/ 2) mousecursor_changes.labels = /*labels*/ ctx[1].slice(0, 4);
	...
	function create_else_block(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				const normal_changes = {};
				if (dirty & /*isActive*/ 1) normal_changes.isActive = /*isActive*/ ctx[0];
				if (dirty & /*labels*/ 2) normal_changes.labels = /*labels*/ ctx[1].slice(8, 12);
				normal.$set(normal_changes);
			},
			i(local) {
				if (current) return;
	...
	function create_if_block$1(ctx) {
		...
		return {
			...
			p(ctx, dirty) {
				...
				if (dirty & /*labels*/ 2) mousescroll_changes.labels = /*labels*/ ctx[1].slice(8, 12);
	...
	function create_fragment$3(ctx) {
		...
		function select_block_type(ctx, dirty) {
			if (/*isMouseControls*/ ctx[4]) return 0;
			return 1;
		}
		...
		return {
			c() {
				...
				div6 = element("div");
				if_block3.c();
				attr(span0, "class", "trigger left svelte-acec6s");
				toggle_class(span0, "active", /*isActive*/ ctx[0]);
				toggle_class(span0, "down", /*isVisitedByHoldingL1*/ ctx[2]);
				attr(span1, "class", "trigger right svelte-acec6s");
				toggle_class(span1, "active", /*isActive*/ ctx[0]);
				toggle_class(span1, "down", /*isVisitedByHoldingR1*/ ctx[3]);
				attr(div0, "class", "container svelte-acec6s");
				attr(div1, "class", "label svelte-acec6s");
				attr(div2, "class", "m-1 svelte-acec6s");
				attr(div3, "class", "m-1 svelte-acec6s");
				attr(div4, "class", "flex svelte-acec6s");
				attr(div5, "class", "m-1 svelte-acec6s");
				attr(div6, "class", "m-1 svelte-acec6s");
				attr(div7, "class", "flex svelte-acec6s");
				attr(div8, "class", "keys-set-container svelte-acec6s");
	...
	function instance$3($$self, $$props, $$invalidate) {
		...
		$$self.$$set = $$props => {
			...
			if ('isMouseControls' in $$props) $$invalidate(4, isMouseControls = $$props.isMouseControls);
		};

		return [isActive, labels, isVisitedByHoldingL1, isVisitedByHoldingR1, isMouseControls];
	}
	...
	// (12:2) {#each labelsSet as labels,idx}
	function create_each_block(ctx) {
		...
		layer = new Layer({
				props: {
					isActive: /*idx*/ ctx[5] + /*layerIndexFrom*/ ctx[1] == /*activeLayer*/ ctx[0],
					isMouseControls: /*idx*/ ctx[5] + /*layerIndexFrom*/ ctx[1] == 4,
					labels: /*labels*/ ctx[3],
					isVisitedByHoldingL1: [1, 3, 5, 7].includes(/*idx*/ ctx[5] + /*layerIndexFrom*/ ctx[1]),
					isVisitedByHoldingR1: [2, 3, 6, 7].includes(/*idx*/ ctx[5] + /*layerIndexFrom*/ ctx[1])
				}
			});
		...
		return {
			...
			p(ctx, dirty) {
				const layer_changes = {};
				if (dirty & /*layerIndexFrom, activeLayer*/ 3) layer_changes.isActive = /*idx*/ ctx[5] + /*layerIndexFrom*/ ctx[1] == /*activeLayer*/ ctx[0];
				if (dirty & /*layerIndexFrom*/ 2) layer_changes.isMouseControls = /*idx*/ ctx[5] + /*layerIndexFrom*/ ctx[1] == 4;
				if (dirty & /*labelsSet*/ 4) layer_changes.labels = /*labels*/ ctx[3];
				if (dirty & /*layerIndexFrom*/ 2) layer_changes.isVisitedByHoldingL1 = [1, 3, 5, 7].includes(/*idx*/ ctx[5] + /*layerIndexFrom*/ ctx[1]);
				if (dirty & /*layerIndexFrom*/ 2) layer_changes.isVisitedByHoldingR1 = [2, 3, 6, 7].includes(/*idx*/ ctx[5] + /*layerIndexFrom*/ ctx[1]);
	...
	function create_fragment$2(ctx) {
		let div;
		let current;
		let each_value = ensure_array_like(/*labelsSet*/ ctx[2]);
		let each_blocks = [];
		...
		return {
			...
			p(ctx, [dirty]) {
				if (dirty & /*layerIndexFrom, activeLayer, labelsSet*/ 7) {
					each_value = ensure_array_like(/*labelsSet*/ ctx[2]);
					let i;
	...
	function instance$2($$self, $$props, $$invalidate) {
		...
		let { layerIndexFrom = 0 } = $$props;
		let { labelsSet = [] } = $$props;

		$$self.$$set = $$props => {
			if ('activeLayer' in $$props) $$invalidate(0, activeLayer = $$props.activeLayer);
			if ('layerIndexFrom' in $$props) $$invalidate(1, layerIndexFrom = $$props.layerIndexFrom);
			if ('labelsSet' in $$props) $$invalidate(2, labelsSet = $$props.labelsSet);
		};

		return [activeLayer, layerIndexFrom, labelsSet];
	}
	...
	function create_fragment$1(ctx) {
		...
		row1 = new Row({
				props: {
					labelsSet: /*level2Labels*/ ctx[2],
					activeLayer: /*activeLayer*/ ctx[0],
					mouseControlsAtIndex: 0,
					layerIndexFrom: 4
				}
			});
